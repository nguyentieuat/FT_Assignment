package com.example.managersharefile.filter;
...
public class JwtRequestFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
		...
		final String requestTokenHeader = request.getHeader(Constants.JWT_HEADER);

		String username = null;
		String jwtToken = null;
		// JWT Token is in the form.
		if (!Objects.isNull(requestTokenHeader)) {
			...
			logger.warn("JWT Token does not exits");
		}
